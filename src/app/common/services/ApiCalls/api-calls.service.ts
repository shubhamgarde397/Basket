...
import { GetFullApiService } from './get-full-api.service';
...
export class ApiCallsService {
  ...
  constructor(public http: Http, public httpClient: HttpClient, public getfullapi: GetFullApiService, public handlefunction: handleFunction) { }

  handleData_New(api, apiCall, noOfIDs: number, formBody = {}, id1?, id2?, id3?) {
